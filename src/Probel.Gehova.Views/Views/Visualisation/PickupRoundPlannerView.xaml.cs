...
namespace Probel.Gehova.Views.Views.Visualisation
{
    ...
    /// </summary>
    public sealed partial class PickupRoundPlannerView : Page
    {
        #region Constructors

        public PickupRoundPlannerView()
        {
            InitializeComponent();
        ...
        public PickupRoundViewModel ViewModel => DataContext as PickupRoundViewModel;
